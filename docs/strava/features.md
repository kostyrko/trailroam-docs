...
Browse all imported activities in a sortable, filterable table.

- **Search** by activity name
- **Filter** by sport type (Ride, Run, Hike, Walk, Swim, etc.)
- **Filter** by date range with presets (Last 7 days, Last 30 days, This year)
- **Sort** by date, name, type, distance, speed, moving time, or route status
...
- **Interactive mini-map** with speed-colored route segments
- **Elevation profile** (SVG chart, no external library)
- **Metrics**: Distance, moving time, average speed, elevation gain
- **GPX download** button
- **Open on Strava** link
...
- **Sync** new activities or missing routes
- **Backup** all local data to JSON
- **Restore** from a previous backup
- **Clear** synced data without affecting Strava
- **Sync History** shows past sync operations
